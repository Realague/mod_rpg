...
public class BlockBarrelVine extends Block{
public static final PropertyInteger LEVELS = PropertyInteger.create("levels", 0, 16);
	
	public BlockBarrelVine(Material materialIn, String name) {
		super(Material.wood);
	                ...
	                else
	                {
	                    ...
	                    if (item == Items.glass_bottle)
	                    {
	                        if (i > 0)
	                        {
	                            if (!playerIn.capabilities.isCreativeMode)
	                            {
	                                itemstack1 = new ItemStack(ModItems.bottle_vine,1,0);
