...
public class BlockBlueberry extends BlockBush{

		public BlockBlueberry(String name) 
		{
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float
				...
				{
					if (this == ModBlocks.bush_blueberry) 
					{
						world.setBlockState(pos, ModBlocks.bush_blueberry_simple.getDefaultState());
						dropBerry(world, pos);
					}
					return null == null;
				}
	    ...
	    {
	    	if (this == ModBlocks.bush_blueberry_simple || this == ModBlocks.bush_blueberry)
	    	{
	    		spawnAsEntity(world, pos, new ItemStack(ModItems.blueberry, 1 + RANDOM.nextInt(2))); 
	    	}
	    }
	    protected void makeBerry(World world, BlockPos pos)
	    {
	    	if (this == ModBlocks.bush_blueberry_simple)
	    	{
	    		world.setBlockState(pos, ModBlocks.bush_blueberry.getDefaultState());
	    	}
	    }
