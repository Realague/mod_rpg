...
public class BlockStrawberry extends BlockBush{

		public BlockStrawberry(String name) 
		{
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float
				...
				{
					if (this == ModBlocks.bush_strawberry) 
					{
						world.setBlockState(pos, ModBlocks.bush_strawberry_simple.getDefaultState());
						dropBerry(world, pos);
					}
					return null == null;
				}
	    ...
	    {
	    	if (this == ModBlocks.bush_strawberry_simple || this == ModBlocks.bush_strawberry)
	    	{
	    		spawnAsEntity(world, pos, new ItemStack(ModItems.strawberry, 1 + RANDOM.nextInt(2))); 
	    	}
	    }
	    protected void makeBerry(World world, BlockPos pos)
	    {
	    	if (this == ModBlocks.bush_strawberry_simple)
	    	{
	    		world.setBlockState(pos, ModBlocks.bush_strawberry.getDefaultState());
	    	}
	    }
