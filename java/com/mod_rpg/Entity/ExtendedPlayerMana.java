...
{
	public final static String EXT_PROP_NAME = "ExtendedPlayerMana";
	...
	public static final void register(EntityPlayer player) {
		player.registerExtendedProperties(ExtendedPlayerMana.EXT_PROP_NAME, new ExtendedPlayerMana(player));
	}
	...
	public static final ExtendedPlayerMana get(EntityPlayer player) {
		return (ExtendedPlayerMana) player.getExtendedProperties(EXT_PROP_NAME);
	}
	 ...
	 */
	public void copy(ExtendedPlayerMana props) {
