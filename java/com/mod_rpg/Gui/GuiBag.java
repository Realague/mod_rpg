...
public class GuiBag extends GuiContainer
{
	...
	private static final ResourceLocation iconLocation = new ResourceLocation("mod_rpg:textures/gui/bag.png");

	/** The inventory to render on screen */
	private final InventoryBag inventory;

	public GuiBag(EntityPlayer player, InventoryPlayer inv1, InventoryBag inv2)
	{
		super(new ContainerBag(player, inv1, inv2));
		this.inventory = inv2;
	}
