...
public class ItemPickaxeCustom extends ItemToolCustom{
    ...
    public ItemPickaxeCustom(CustomToolMaterial material, String name, int manche)
	{
		super(1.0F, material, EFFECTIVE_ON, manche);
	setUnlocalizedName(name);
//	this.setCreativeTab(TabsT);
	}
