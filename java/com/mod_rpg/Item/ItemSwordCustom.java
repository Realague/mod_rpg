...
public class ItemSwordCustom extends SimpleItem{
	private float attackDamage;
    private final com.mod_rpg.Item.CustomToolMaterial material;
    private static final String __OBFID = "CL_00000072";

    public ItemSwordCustom(CustomToolMaterial material, String name, int garde)
    {
    	super (name);
        this.material = material;
        maxStackSize = 1;
        setMaxDamage(material.getMaxUses()+ garde);
