...
public class ContainerBag extends Container
{
	...
	ARMOR_START = InventoryBag.INV_SIZE, // INV_SIZE = 10, so slots 0 to 9 are the custom inventory, armor starts at the next slot (i.e. 10)
	...
	public ContainerBag(EntityPlayer player, InventoryPlayer inv, InventoryBag bag)
	{
		int i = 0;
		inventory = bag;
		...
		for (i = 0; i < InventoryBag.INV_SIZE; ++i) {
			addSlotToContainer(new SlotBag(inventory, i, 80 + (18*(i%5)), 8 + (18 * (int)(i/5))));
		}
